...
class Agent:
    ...
    def __init__(self, tag_slug):
        ...
        self.tracking = centroidtracker.CentroidTracker()
    ...
    def _run_frame_worker(self, index, frame_queue, storage_queue, frame_callback):
        ...
        try:
            ...
            alpr = openalpr.Alpr('br', path.join(path.dirname(path.abspath(__file__)), 'config', 'openalpr.conf'), '/usr/share/openalpr/runtime_data')
